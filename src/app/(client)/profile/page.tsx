  ...
  return (
    <div className="max-w-[1920px] mx-auto px-6 md:px-12 lg:px-24 py-32 min-h-screen">
      <div className="mb-16">
        ...
        <div className="mt-4"><span className="bg-brand-accent/10 px-3 py-1 text-brand-accent font-bold text-xs uppercase tracking-widest rounded-full">{session.user.role}</span></div>
      </div>

      <div className="grid grid-cols-1 lg:grid-cols-4 gap-12">
        {/* Sidebar */}
        <div className="lg:col-span-1 space-y-2">
          <div className="bg-white dark:bg-[#0a0a0a] rounded-2xl border border-gray-200 dark:border-white/10 p-6 flex items-center gap-4 hover:border-brand-accent/50 cursor-pointer transition-colors shadow-lg shadow-black/5 dark:shadow-white/5">
            <Package className="text-brand-accent" size={24} />
            <h3 className="font-bold tracking-widest uppercase text-sm">Order History</h3>
          </div>
          <div className="bg-transparent rounded-2xl border border-transparent p-6 flex items-center gap-4 hover:bg-gray-50 dark:hover:bg-white/5 cursor-pointer transition-colors text-brand-muted">
            <MapPin size={24} />
